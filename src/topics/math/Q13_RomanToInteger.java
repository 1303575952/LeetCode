 ...
 * @author FELIX
 *
 *         Question:Roman numerals are represented by seven different symbols:
 *         I, V, X, L, C, D and M. Symbol Value I 1 V 5 X 10 L 50 C 100 D 500 M
 *         1000 For example, two is written as II in Roman numeral, just two
 *         one's added together. Twelve is written as, XII, which is simply X +
 *         II. The number twenty seven is written as XXVII, which is XX + V +
 *         II. Roman numerals are usually written largest to smallest from left
 ...
 *         subtraction is used: I can be placed before V (5) and X (10) to make
 *         4 and 9. X can be placed before L (50) and C (100) to make 40 and 90.
 ...
 *         3.
 * 
 *         Example 5: Input: "MCMXCIV" Output: 1994 Explanation: M = 1000, CM =
 *         900, XC = 90 and IV = 4.
 */
public class Q13_RomanToInteger {
	...
	public static void main(String[] args) {
		String s = "IV";
		System.out.println(new Q13_RomanToInteger().romanToInt(s));
	}
