 ...
 * @author FELIX
 *
 *         Question: Implement atoi which converts a string to an integer. The
 ...
 *         as a numerical value. The string can contain additional characters
 *         after those that form the integral number, which are ignored and have
 *         no effect on the behavior of this function. If the first sequence of
 *         non-whitespace characters in str is not a valid integral number, or
 *         if no such sequence exists because either str is empty or it contains
 *         only whitespace characters, no conversion is performed. If no valid
 ...
 * 
 *         Example 2: Input: "   -42" Output: -42 Explanation: The first
 *         non-whitespace character is '-', which is the minus sign. Then take
 *         as many numerical digits as possible, which gets 42.
 * 
 *         Example 3: Input: "4193 with words" Output: 4193 Explanation:
 ...
 * 
 *         Example 5: Input: "-91283472332" Output: -2147483648 Explanation: The
